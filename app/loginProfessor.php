...
class LoginProfessor extends PHPFrodo
{
    ...
    public function proccess()
    {
        ...
        {
            $this->message_login = "$('#form-login').popover({'trigger':'manual','placement':'right','title': 'Atenção:','content':'Login / Senha requeridos!'});";
            $this->message_login .= "$('#form-login').popover('show');";
            $this->message_login = "";
        }
    }
        ...
        if ( $this->postIsValid( array( 'professor_email' => 'string' ) ) )
        {
            ...
            if ( $this->execute() )
            {
                ...
                if ( $mail->Send() )
                {
                    ...
                    $this->message_login .= "$('#form-login #professor_senha').popover({'trigger':'manual', 'placement':'right', 'title': 'Recuperação de senha:', 'content':'Sua nova senha foi enviada por e-mail!'});";
